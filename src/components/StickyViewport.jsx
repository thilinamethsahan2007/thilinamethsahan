    ...
    return (
        <span>
            ...
            <motion.span
                ...
                style={{ marginLeft: "8px", width: "clamp(10px, 1.5vw, 20px)", height: "1em", backgroundColor: "var(--accent)", display: "inline-block", verticalAlign: "baseline", transform: "translateY(0.1em)" }}
            />
        </span>
    );
};
...
const parseHighlightedText = (text) => {
    ...
    return parts.map((part, i) => {
        if (part.startsWith('**') && part.endsWith('**')) {
            return <span key={i} style={{ color: '#ffd700', fontWeight: 600 }}>{part.slice(2, -2)}</span>;
        }
        return part;
    });
};
    ...
    return (
        <motion.div
            ...
            whileHover={{
                ...
                rotateX: 5,
                rotateY: -5,
                boxShadow: "0 25px 50px -15px rgba(255, 215, 0, 0.35), 0 0 30px rgba(212, 175, 55, 0.2)"
            }}
        ...
        >
            ...
            <div style={{
                ...
                background: `radial-gradient(circle 250px at ${mousePos.x}px ${mousePos.y}px, rgba(255, 255, 255, 0.1), transparent)`,
                transition: "opacity 0.3s"
            }} />

            {/* Content Container with 3D Float */}
            <div style={{ transform: "translateZ(40px)", display: "flex", flexDirection: "column", flex: 1, zIndex: 10 }}>
                ...
                {/* Project Image - Cinematic Grayscale */}
                {repo.image_url && (
                    <div style={{
                        width: "100%",
                        height: "200px",
                        ...
                        <img
                            ...
                            style={{
                                ...
                                height: "100%",
                                objectFit: "cover",
                                filter: isHovered ? "grayscale(0%) brightness(1.1)" : "grayscale(80%) brightness(0.6)",
                ...
                {/* Content Area */}
                <div style={{ padding: "1.5rem", paddingBottom: "3rem", flex: 1, display: "flex", flexDirection: "column", transform: "translateZ(20px)" }}>
                    <h4 style={{
                        fontSize: "1.8rem",
                        marginBottom: "0.5rem",
                        fontWeight: 700,
...
export const StickyViewport = () => {
    ...
    return (
        ...
        >
            ...
            {/* Core Deep Space Base */}
            <div style={{
                position: "absolute", inset: 0, zIndex: -3,
                background: "radial-gradient(ellipse at center, #0a0a0a 0%, #000000 100%)"
            }} />

            {/* Cyber-Luxury Blueprint Grid */}
            <div style={{
            ...
            <motion.div
                style={{
                    ...
                    background: "radial-gradient(circle at center, rgba(184, 134, 11, 0.3), transparent)",
                    zIndex: -1,
                    filter: "blur(100px)",
                    position: "absolute",
                    top: "10%",
            ...
            <motion.div
                style={{
                    ...
                    background: "radial-gradient(circle at center, rgba(205, 127, 50, 0.2), transparent)",
                    zIndex: -1,
                    filter: "blur(140px)",
                    position: "absolute",
                    bottom: "-10%",
            ...
            >
                I'm <span className="gradient-text">
                    {siteSettings.hero_name.split('').map((char, index) => (
                        <motion.span
                            key={index}
                            initial={{ y: 30, opacity: 0 }}
                            animate={{ y: 0, opacity: 1 }}
                            transition={{ delay: 0.5 + Math.random() * 0.5, type: "spring", stiffness: 100 }}
            ...
            >
                <motion.span 
                    style={{ fontSize: "0.6rem", letterSpacing: "3px", color: "var(--accent)" }}
                ...
                >
                    ...
                    <div style={{ position: "relative", width: "300px", height: "300px", margin: "0 auto" }}>
                        ...
                        <motion.div
                            animate={{
                                boxShadow: [
                                    "0 0 20px rgba(212, 175, 55, 0.3), 0 0 50px rgba(255, 215, 0, 0.2)",
                                    "0 0 30px rgba(212, 175, 55, 0.5), 0 0 70px rgba(255, 215, 0, 0.4)",
                                    "0 0 20px rgba(212, 175, 55, 0.3), 0 0 50px rgba(255, 215, 0, 0.2)"
                                ]
                            }}
                            transition={{
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(80px, 1fr))", gap: "1rem", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "2rem" }}>
                            {siteSettings.skills.map((skill, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <IconComp size={24} style={{ color: ["#d4af37", "#ffd700", "#c5a059"][i % 3], margin: "0 auto 0.5rem" }} />
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%" }}>
                    <h2 style={{ fontSize: "clamp(2rem, 5vw, 4rem)", fontWeight: "bold", marginBottom: "3rem" }}>
                        {siteSettings.socials_title ? (
                            siteSettings.socials_title.split(' ').map((word, i) => (
                                <span key={i} style={{ color: i === 1 ? 'var(--accent)' : 'inherit' }}>{word} </span>
                            ))
                        ) : (
                            <>Online <span style={{ color: "var(--accent)" }}>Presence</span>.</>
                        )}
                    </h2>
                    ...
                    <div style={{ display: "flex", gap: "3rem", flexWrap: "wrap", justifyContent: "center" }}>
                        {(siteSettings.socials || []).filter(item => item.url).map((social, index) => {
                            ...
                            const colors = ["#d4af37", "#ffd700", "#b8860b", "#f3e5ab", "#c5a059"];
